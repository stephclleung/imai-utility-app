...
/** 
* Decodes the name of a card from a regex string
* @param {number} deck number or string
* @param {number} suit number or string
...
* @param {Array} cards An array of deciphered cards with {deck,suit}
* @returns {Buffer []} 
 */
...
* @param {Buffer []} cards An array of deciphered cards with {deck,suit}
